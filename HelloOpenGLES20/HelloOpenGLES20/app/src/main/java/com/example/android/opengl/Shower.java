...
//staotemp            "    gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);  " +
    ...
    private final String fsBG =
        ...
        "                                                         " +
        " vec4 randomDither() {                                   " +
        "   float random = rand(gl_FragCoord.xy)*uRandomMultiple; " +
        "   float r = (vVertexColor.r*COLOR + random)/COLOR;      " +
        "   float g = (vVertexColor.g*COLOR + random)/COLOR;      " +
        "   float b = (vVertexColor.b*COLOR + random)/COLOR;      " +
        "   return vec4(r, g, b, vVertexColor.a);                 " +
        " }                                                       " +
        "                                                         " +
        " void main() {                                           " +
